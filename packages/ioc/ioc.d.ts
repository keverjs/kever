...
declare type InjectDecoratorType = (tag: Tag, payload?: {
    params?: any;
}) => PropertyDecorator;
...
declare type PropertyPluginType = (tag: Tag, payload?: {
    params?: any;
...
declare type RoutePluginType = <T>(tag: Tag, type: AopRoute, payload?: {
    params?: any;
